import { DOWNLOAD_FOLDER_PATH } from './src/config/pathConst';
import SlackReporter, { IncomingWebhookSendArguments } from '@moroo/wdio-slack-reporter';
...
const videoFile = __dirname + '/tmpvideo.y4m';
...
//                '--use-file-for-fake-video-capture=' + videoFile
    ...
    [
        ...
        ['image-comparison',
        {
            ...
            baselineFolder: path.join(process.cwd(), './src/data/baseline/'),
            formatImageName: '{tag}-{logName}-{width}x{height}',
            screenshotPath: path.join(process.cwd(), './src/data/vr/'),
...
/*        [
            SlackReporter,
            {
                ...
                {
                    type: 'webhook',
                    // Set Slack Reporter to 'mbdv_dwango_auto_test_uat'
                    webhook: process.env.SLACK_WEBHOOK_URL || "SLACK_URL",
                    slackIconUrl: "https://webdriver.io/img/webdriverio.png",          
                },
                // Set the Title of Test.
                title: 'Title for Slack Report',
                // Set the notification of Test Start
                notifyTestStartMessage: true,
                // Set the notification of Test Failed
                ...
                createFailedTestPayload: function (hookAndTest: HookStats | TestStats): IncomingWebhookSendArguments {
    ...
    onPrepare: () => {
        ...
        [
           removeSync('.tmp/'),
           mkdirsSync('.tmp/files/'),
           mkdirsSync('.tmp/report/'),
           mkdirsSync('src/img/'),
           mkdirsSync('src/data/'),
        ]    
      },
    ...
    , before: function (capabilities, specs) {
        browser.setWindowSize(1620, 1024);
     },
    /**
    ...
    beforeFeature: function (uri, feature) {
        SlackReporter.setResultsUrl(feature.name);
    },
    /**
     *
